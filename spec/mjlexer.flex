...
">=" 		{ return new_symbol(sym.GREATEROREQ, yytext()); }
"<" 		{ return new_symbol(sym.LESS, yytext()); }
"<=" 		{ return new_symbol(sym.LESSOREQ, yytext()); }
...
"=>"		{ return new_symbol(sym.MEANS, yytext()); }
...
("true"|"false")	{ return new_symbol(sym.BOOLEAN, Boolean.parseBoolean(yytext())); }
