...
public class MethDeclTypeAndName implements SyntaxNode {
    ...
    public MethDeclTypeAndName (TypeOrVoid TypeOrVoid, String methName) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethDeclTypeAndName(\n");
