...
public class ClassVarDeclarList extends ClassVarDeclList {

    private ClassVarDeclList ClassVarDeclList;
    private ClassVarDecl ClassVarDecl;

    public ClassVarDeclarList (ClassVarDeclList ClassVarDeclList, ClassVarDecl ClassVarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassVarDeclarList(\n");
