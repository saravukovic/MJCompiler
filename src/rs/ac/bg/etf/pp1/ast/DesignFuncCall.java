...
public class DesignFuncCall extends DesignatorStatement {

    private Designator Designator;
    private FunctionCalled FunctionCalled;
    private ActParsList ActParsList;

    public DesignFuncCall (Designator Designator, FunctionCalled FunctionCalled, ActParsList ActParsList) {
